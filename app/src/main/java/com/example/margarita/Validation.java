...
public class Validation {
    ...
    public static final String EMAIL_REGEX_PATTERN = "^([a-z0-9._-]+){5,50}@([a-z0-9._-]+){2,10}.([a-z]){2,}$"; //Zemiau sias eilutes (simboliu kratinius) paversime i grieztas taisykles
